...
public class SwipeHelper {
    ...
    private void checkEnterDraggingOnMove(MotionEvent ev) {
        if (mCurrView != null) {
            mVelocityTracker.addMovement(ev);
            float pos = getPos(ev);
    ...
    public void dismissChild(final View view, float velocity) {
        mCallback.onChildDismissStart(view);
        final View animView = mCallback.getChildContentView(view);
        final boolean canAnimViewBeDismissed = (view == mCurrView ? mCanCurrViewBeDimissed : mCallback.canChildBeDismissed(view));
        float newPos;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (!mDragging && ev.getAction() == MotionEvent.ACTION_MOVE) {
            checkEnterDraggingOnMove(ev);
        }
        if (!mDragging) {
            return false;
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    // maxScrollDistance
                    if (CONSTRAIN_SWIPE && !mCanCurrViewBeDimissed) {
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mCurrView != null) {
                    ...
                    boolean dismissChild = mCanCurrViewBeDimissed &&
    ...
    public interface Callback {
        ...
        void onChildDismissStart(View view);
