...
sp_error Session::setStreamingBitrate(sp_bitrate bitrate) {
    LOGV("%s %d", __func__, bitrate);
    return sp_session_preferred_bitrate(mSession, bitrate);
}

sp_error Session::setOfflineBitrate(sp_bitrate bitrate) {
    LOGV("%s %d", __func__, bitrate);
